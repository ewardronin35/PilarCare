      ...
      <i class="fas fa-stethoscope"></i> Physical Examination
        ...
        <div id="medical" class="tab forms-container">
            ...
            <div class="form-container">
                ...
                <form method="POST" action="{{ isset($record) && $record->id ? route('doctor.medical-record.update', $record->id) : '#' }}" enctype="multipart/form-data" id="medical-record-form">
                @csrf
@method('PUT')
...
<div id="physical-examination" class="tab forms-container hidden">
        ...
        <form method="POST" action="{{ route('doctor.physical-examination.store') }}" id="physical-examination-form">
            @csrf
...
<script src="https://unpkg.com/filepond-plugin-image-preview/dist/filepond-plugin-image-preview.js"></script>
    ...
    const Routes = {
    searchMedicalRecord: "{{ route('doctor.medical-record.search') }}",
    getAllMedicalRecords: "{{ route('doctor.medical-records.all-data') }}",
    viewMedicalRecord: (id) => "{{ url('doctor/medical-records') }}/" + id + "/view",
    downloadMedicalRecordPdf: (id) => "{{ url('doctor/medical-records') }}/" + id + "/download-pdf",
    storePhysicalExamination: "{{ route('doctor.physical-examination.store') }}",
    medicalRecordUpdate: (id) => "{{ url('doctor/medical-records') }}/" + id,
    medicalRecordHistory: "{{ route('doctor.medical-record.history') }}", // NEW!
};
