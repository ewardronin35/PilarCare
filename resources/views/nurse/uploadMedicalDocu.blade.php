    ...
    $('#bulk-approve-btn').on('click', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: '{{ route("nurse.medical-records.bulk-approve") }}',
                    method: 'POST',
                    headers: {
    ...
    $('#bulk-reject-btn').on('click', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: '{{ route("nurse.medical-records.bulk-reject") }}',
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        ...
        function openMedicalRecordModal(medicalRecordId) {
            ...
            fetch(`/nurse/medical-record/${medicalRecordId}`)
        ...
        function fetchNewRecords() {
            fetch('/nurse/medical-records/pending', {
                method: 'GET',
                headers: {
