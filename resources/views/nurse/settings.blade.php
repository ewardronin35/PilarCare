<x-app-layout>
    ...
    <div class="settings-container">
        ...
        <div class="form-container">
            ...
            <form action="{{ route('settings.updateAdditional') }}" method="POST" enctype="multipart/form-data" id="additionalInfoForm">
                @csrf
                @method('PUT')
    ...
    <div class="modal-overlay" id="imageUploadModal">
        <div class="modal-content">
            ...
            <form action="{{ route('settings.updateImage') }}" method="POST" enctype="multipart/form-data" id="imageUploadForm">
                @csrf
                @method('PUT')
    ...
    <script>
        ...
        document.getElementById('deleteAccountBtn').addEventListener('click', function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = "{{ route('settings.delete') }}";
                }
            });
        });
