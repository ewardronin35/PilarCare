    ...
    <div class="main-content">
        ...
        <div id="upload-tab" class="tab-content active">
            <div class="upload-section center-text">
                ...
                <a href="{{ route('nurse.download.templates') }}" class="toggle-button">Download Excel Template</a>
...
function deleteStudent(studentId) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            fetch(`/nurse/students/${studentId}`, {
                method: 'POST',
                headers: {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('upload-form').addEventListener('submit', function(event) {
        ...
        fetch('{{ route('nurse.students.import') }}', {
            method: 'POST',
            body: formData,
            headers: {
                'X-CSRF-TOKEN': '{{ csrf_token() }}'
    ...
    document.getElementById('late-student-form').addEventListener('submit', function(event) {
        ...
        fetch('{{ route('nurse.students.add') }}', {
            method: 'POST',
            body: formData,
            headers: {
                'X-CSRF-TOKEN': '{{ csrf_token() }}'
    ...
    function fetchAndUpdateStudentsTable() {
        fetch('{{ route('nurse.students.enrolled') }}', {
            method: 'GET',
            headers: {
                'X-CSRF-TOKEN': '{{ csrf_token() }}'
            }
    ...
    function attachToggleApprovalEvents() {
        ...
        document.querySelectorAll('.toggle-approval').forEach(input => {
            input.addEventListener('change', function() {
                ...
                var actionUrl = `{{ url('nurse/students') }}/${studentId}/toggle-approval`;
    ...
    document.getElementById('edit-student-form').addEventListener('submit', function(event) {
        ...
        fetch(`{{ url('nurse/students') }}/${studentId}/edit`, {
            method: 'POST',
            body: formData,
            headers: {
                'X-CSRF-TOKEN': '{{ csrf_token() }}'
