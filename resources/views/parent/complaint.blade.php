<x-app-layout :pageTitle="'Complaints'">
    ...
    <div class="main-content">
        ...
        <div class="complaints-section">
            <h2>Child's Complaint History</h2>
                                ...
                                <td>
                                    <div class="action-buttons">
                                        ...
                                        @if(isset($complaint->report_url))
                                            <a href="{{ route('parent.complaint.download-pdf', ['id' => $complaint->id]) }}" target="_blank" class="pdf-button">
                                                <i class="fas fa-file-pdf"></i> View PDF
                                            </a>
                                            <a href="{{ route('parent.complaint.download-pdf', ['id' => $complaint->id]) }}" download class="download-button">
    ...
    <script>
        ...
        function openPreviewModal(complaintId) {
            fetch(`/parent/complaint/${complaintId}`)
                .then(response => {
                    if (!response.ok) {
                ...
                .then(data => {
                    ...
                    modalBody.innerHTML = `
                        ...
                        ${data.report_url ? `
                            <a href="${data.report_url}" target="_blank" class="pdf-link">
                                <i class="fas fa-file-pdf"></i> View PDF
                            </a>
                        ` : ''}
                    `;
