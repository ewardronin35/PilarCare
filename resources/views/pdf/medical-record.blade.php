...
<table class="details-table">
    ...
    <tbody>
        <tr>
            ...
            <td>{{ $physicalExamination->height ?? 'No Physical Examinations' }}</td>
        </tr>
        <tr>
            <td><strong>Weight:</strong></td>
            <td>{{ $physicalExamination->weight ?? 'No Physical Examinations' }}</td>
        </tr>
        <tr>
            <td><strong>Vision:</strong></td>
            <td>{{ $physicalExamination->vision ?? 'No Physical Examinations' }}</td>
        </tr>
        <tr>
            <td><strong>Remarks:</strong></td>
            <td>{{ $physicalExamination->remarks ?? 'No Physical Examinations' }}</td>
        </tr>
    </tbody>
</table>
