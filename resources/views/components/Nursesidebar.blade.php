...
<div class="sidebar">
    ...
    <nav class="menu">
        <ul>
            <!-- Dashboard -->
            <li class="{{ Route::currentRouteName() == 'nurse.dashboard' ? 'active' : '' }}">
            ...
            <!-- Complaints -->
            <li class="{{ Route::currentRouteName() == 'nurse.complaint' ? 'active' : '' }}">
            ...
            <li class="has-submenu {{ Route::currentRouteName() == 'nurse.medical-record.index' || Route::currentRouteName() == 'nurse.dental-record.index' ? 'active' : '' }}">
                <a href="#">
                ...
                <ul class="submenu">
                    <li class="{{ Route::currentRouteName() == 'nurse.medical-record.index' ? 'active' : '' }}">
                        <a href="{{ route('nurse.medical-record.index') }}">View Medical Record</a>
                    </li>
                    <li class="{{ Route::currentRouteName() == 'nurse.dental-record.index' ? 'active' : '' }}">
                        <a href="{{ route('nurse.dental-record.index') }}">View Dental Record</a>
                    </li>
                </ul>
            </li>
            ...
            <!-- Inventory -->
            <li class="{{ Route::currentRouteName() == 'nurse.inventory' ? 'active' : '' }}">
