<div class="sidebar">
    ...
    <nav class="menu">
        <ul>
            ...
            <!-- Complaints -->
            <li class="{{ Route::currentRouteName() == 'teacher.complaint' ? 'active' : '' }}">
            ...
            <!-- Appointment -->
            <li class="{{ Route::currentRouteName() == 'teacher.appointment' ? 'active' : '' }}">
            ...
            <li class="{{ Route::currentRouteName() == 'teacher.settings.edit' ? 'active' : '' }}">
