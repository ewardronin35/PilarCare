...
<div class="sidebar">
    ...
    <nav class="menu">
        <ul>
            ...
            <!-- Complaints -->
            <li class="{{ Route::currentRouteName() == 'admin.complaint' ? 'active' : '' }}">
            ...
            <li class="has-submenu {{ Route::currentRouteName() == 'admin.medical-record.index' || Route::currentRouteName() == 'admin.dental-record.index' ? 'active' : '' }}">
                <a href="#">
                ...
                <ul class="submenu">
                    <li class="{{ Route::currentRouteName() == 'admin.medical-record.index' ? 'active' : '' }}">
                        <a href="{{ route('admin.medical-record.index') }}">View Medical Record</a>
                    </li>
                    <li class="{{ Route::currentRouteName() == 'admin.dental-record.index' ? 'active' : '' }}">
                        <a href="{{ route('admin.dental-record.index') }}">View Dental Record</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="has-submenu {{ 
                Route::currentRouteName() == 'admin.students.upload' || 
                Route::currentRouteName() == 'admin.staff.upload' || 
                Route::currentRouteName() == 'admin.teachers.upload' || 
                Route::currentRouteName() == 'admin.parents.upload' || 
                Route::currentRouteName() == 'admin.nurses.upload' || 
                Route::currentRouteName() == 'admin.doctors.upload' ? 'active' : '' }}">
                <a href="#">
                ...
                <ul class="submenu">
                    <li class="{{ Route::currentRouteName() == 'admin.students.upload' ? 'active' : '' }}">
                        <a href="{{ route('admin.students.upload') }}" id="admin-enrolled-students-link">Students</a>
                    </li>
                    <li class="{{ Route::currentRouteName() == 'admin.staff.upload' ? 'active' : '' }}">
                        <a href="{{ route('admin.staff.upload') }}">Staffs</a>
                    </li>
                    ...
                    <li class="{{ Route::currentRouteName() == 'admin.doctors.upload' ? 'active' : '' }}">
                        <a href="{{ route('admin.doctors.upload') }}">Doctor</a>
                    </li>
                </ul>
            </li>

            <!-- Appointment -->
            <li class="{{ Route::currentRouteName() == 'admin.appointment' ? 'active' : '' }}">
            ...
            <!-- Inventory -->
            <li class="{{ Route::currentRouteName() == 'admin.inventory' ? 'active' : '' }}">
            ...
            <!-- Reports and Logs -->
            <li class="{{ Route::currentRouteName() == 'admin.monitoring-report-log' ? 'active' : '' }}">
                <a href="{{ route('admin.monitoring-report-log') }}">
            ...
            <li class="{{ Route::currentRouteName() == 'admin.profiles.index' ? 'active' : '' }}">
                <a href="{{ route('admin.profiles.index') }}">
                    <span class="icon"><i class="fas fa-users"></i></span>
                    <span class="menu-text">View All Profiles</span>
                </a>
            </li>

            <!-- Profile Management (Renamed from Settings) -->
            <li class="{{ Route::currentRouteName() == 'admin.settings.edit' ? 'active' : '' }}">
