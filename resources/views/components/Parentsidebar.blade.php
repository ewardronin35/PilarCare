<div class="sidebar">
    ...
    <nav class="menu">
        <ul>
            <li><a href="{{ route('parent.dashboard') }}" id="student-dashboard-link"><span class="icon"><i class="fas fa-tachometer-alt"></i></span><span class="menu-text">Dashboard</span></a></li>
            <li><a href="{{ route('parent.complaint') }}"><span class="icon"><i class="fas fa-comments"></i></span><span class="menu-text">Complaints</span><span class="submenu-toggle"></span></a>
            <li><a href="{{ route('parent.appointment') }}" id="admin-appointment-link"><span class="icon"><i class="fas fa-calendar-check"></i></span><span class="menu-text">Appointment</span></a></li>
            ...
            <li class="has-submenu">
                ...
                <ul class="submenu">
                    ...
                    <li><a href="#">View Dental Record</a></li>
