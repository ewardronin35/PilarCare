<div class="sidebar">
    ...
    <nav class="menu">
        <ul>
            ...
            <!-- Complaints -->
            <li class="{{ Route::currentRouteName() == 'parent.complaint' ? 'active' : '' }}">
                <a href="{{ route('parent.complaint') }}">
            ...
            <li class="has-submenu {{ Route::currentRouteName() == 'parent.medical-record' || Route::currentRouteName() == 'parent.dental-record' ? 'active' : '' }}">
                <a href="#">
                ...
                <ul class="submenu">
                    <li class="{{ Route::currentRouteName() == 'parent.medical-record' ? 'active' : '' }}">
                        <a href="{{ route('parent.medical-record') }}">View Medical Record</a>
                    </li>
                    <li class="{{ Route::currentRouteName() == 'parent.dental-record' ? 'active' : '' }}">
                        <a href="{{ route('parent.dental-record') }}">View Dental Record</a>
                    </li>
                </ul>
            </li>
            ...
            <!-- Appointment -->
            <li class="{{ Route::currentRouteName() == 'parent.appointment' ? 'active' : '' }}">
            ...
            <li class="{{ Route::currentRouteName() == 'parent.settings.edit' ? 'active' : '' }}">
                <a href="{{ route('parent.settings.edit') }}">
