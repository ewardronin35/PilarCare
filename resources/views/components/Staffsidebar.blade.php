<div class="sidebar">
    ...
    <nav class="menu">
        <ul>
            <li><a href="{{ route('staff.dashboard') }}" id="staff-dashboard-link"><span class="icon"><i class="fas fa-tachometer-alt"></i></span><span class="menu-text">Dashboard</span></a></li>
            <li><a href="{{ route('staff.complaint') }}"><span class="icon"><i class="fas fa-comments"></i></span><span class="menu-text">Complaints</span><span class="submenu-toggle"></span></a>
            <li><a href="{{ route('staff.appointment') }}" id="staff-appointment-link"><span class="icon"><i class="fas fa-calendar-check"></i></span><span class="menu-text">Appointment</span></a></li>
            ...
            <li><a href="{{ route('staff.upload-pictures') }}">Health Approval</a></li>
        @endif
                            <li><a href="{{ route('staff.medical-record') }}">View Medical Record</a></li>
                    <li><a href="{{ route('staff.dental-record') }}">View Dental Record</a></li>
                </ul>
    </li>  
    <li class="has-submenu">
