...
@keyframes slideIn {
    ...
    <div class="main-content">
        <div class="tabs">
            <div class="tab active" data-tab="upload-tab">Upload Staff List</div>
            <div class="tab" data-tab="late-staff-tab">Add Late Staff</div>
            <div class="tab" data-tab="staff-tab">View Staff</div>
        </div>
        ...
        <div id="upload-tab" class="tab-content active">
            <div class="upload-section center-text">
                ...
                <a href="{{ route('admin.download.staffs') }}" class="toggle-button">Download Excel Template</a>
...
searchInput.addEventListener('input', function() {
    ...
    function attachToggleApprovalEvents() {
        ...
        document.querySelectorAll('.toggle-approval').forEach(input => {
            input.addEventListener('change', function() {
                ...
                var actionUrl = `{{ url('admin/staff') }}/${staffId}/toggle-approval`;
    ...
    document.getElementById('edit-staff-form').addEventListener('submit', function(event) {
        ...
        fetch(`{{ url('admin/staff') }}/${staffId}/edit`, {
            method: 'POST',
            body: formData,
            headers: {
                'X-CSRF-TOKEN': '{{ csrf_token() }}'
