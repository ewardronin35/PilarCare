<x-app-layout :pageTitle="'Dental Record'">
    ...
    <body>
        ...
        <div class="main-container">
            ...
            <div class="dental-records">
                ...
                <form id="dental-record-form" action="{{ route('teacher.dental-record.store') }}" method="POST">
                    @csrf
  ...
  <path
    ...
    @if(!$dentalRecord && !$nextExamination)
        <p>No dental examination records available for this teacher.</p>
    @endif
...
<script src="{{ asset('js/dental.js') }}"></script>
    ...
    <script>
        ...
        var storeDentalRecordUrl = "{{ route('teacher.dental-record.store') }}";
        var getToothStatusUrl = "{{ route('teacher.get-tooth-status') }}"; // Pass the route to JS
        var getDentalExaminationHistoryUrl = "{{ route('teacher.dental-examination.history') }}";
        var getToothHistoryUrl = "{{ route('teacher.tooth-history') }}"; // Ensure this is correct
