...
<button type="submit" class="button">Save</button>
    ...
    <a href="{{ route('teacher.medical-record.downloadPdf', $medicalRecord->id) }}" class="btn btn-primary">
        Download Medical Record PDF
    </a>
@endif
        <a href="{{ route('teacher.health-examination.downloadPdf', $healthExamination->id) }}" class="btn btn-primary"> Download PDF </a>
