...
<div class="main-content">
            ...
            <div class="form-container">
                <div class="form-header">
                    ...
                    @if(isset($medicalRecord))
                        <a
                            href="{{ route('staff.medical-record.downloadPdf', $medicalRecord->id) }}"
                    ...
                    @endif
                    <a
                        href="{{ route('staff.health-examination.downloadPdf', $healthExamination->id) }}"
                        class="btn btn-primary no-spinner"
                    >
    ...
    const storeMedicalRecordUrl = "{{ route('staff.medical-record.store') }}";
...
function loadBMIChart(id_number) {
    $.ajax({
        url: `/staff/physical-exam/bmi-data/${id_number}`,  // Include the 'staff' prefix
        type: 'GET',
        success: function(response) {
